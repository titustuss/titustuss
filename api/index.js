...
app.post('/upload-by-link', async (req, res) => {
  ...
  app.post('/places',(req,res)=>{
    const {token}= req.cookies;
    const {title,address,category,addedPhotos,description,contact, email, perks,extraInfo,website, latitude, longitude, price}= req.body; 
    jwt.verify(token, jwtSecret, {}, async (err, userData)=>{
      if(err) throw err;
  ...
  app.put('/places',async (req,res)=>{
    ...
    const {id,title,address,category,addedPhotos,
      ...
      extraInfo,website, latitude, longitude, price}= 
      req.body;
      jwt.verify(token, jwtSecret, {}, async (err, userData)=>{
