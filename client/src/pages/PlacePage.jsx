...
export default function PlacePage(){
        ...
        <div className="flex justify-center items-center bg-black text-white min-w-full mt-10">
            <div className="bg-black grid gap-4">
                <div>
                    ...
                    <button onClick={()=>setShowAllPhotos(false)} className="fixed flex gap-1 right-2 top-8 py-2 px-3 mr-3 rounded-2xl shadow shadow-black-500 bg-white text-black ">
    ...
    <div className="flex flex-col items-center justify-center">
        <div className="max-w-screen-xl px-8 py-5 mt-10 bg-gray-100">
            ...
            <a className="flex gap-1 my-2 font-semibold underline" target="_blank" href={'https://maps.google.com/?g='+ place.address}>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mt-5">
                ...
                <div className="bg-white p-4 rounded-lg shadow-lg mb-3 max-w-sm">
